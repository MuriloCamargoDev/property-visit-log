// Priority cities first, then all other Goiás cities alphabetically
...
export const OTHER_CITIES = [
  "Abadiânia", "Acreúna", "Adelândia", "Água Fria de Goiás", "Água Limpa",
  ...
  "Anhanguera", "Anicuns", "Aporé", "Araçu", "Aragarças",
  "Aragoiânia", "Araguapaz", "Arenópolis", "Aruanã", "Aurilândia",
  ...
  "Campo Limpo de Goiás", "Campos Belos", "Campos Verdes", "Carmo do Rio Verde", "Castelândia",
  "Catalão", "Caturaí", "Cavalcante", "Ceres", "Cezarina",
  ...
  "Cromínia", "Cumari", "Damianópolis", "Damolândia", "Davinópolis",
  ...
  "Goianésia", "Goianira", "Goiás", "Goiatuba", "Gouvelândia",
  ...
  "São João d'Aliança", "São João da Paraúna", "São Luís de Montes Belos", "São Luíz do Norte", "São Miguel do Araguaia",
  "São Miguel do Passa Quatro", "São Patrício", "São Simão", "Serranópolis", "Silvânia",
  "Simolândia", "Sítio d'Abadia", "Taquaral de Goiás", "Teresina de Goiás", "Terezópolis de Goiás",
  "Três Ranchos", "Turvelândia", "Turvânia", "Uruaçu", "Uruana",
  "Urutaí", "Valparaíso de Goiás", "Varjão", "Vianópolis", "Vicentinópolis",
  "Vila Boa", "Vila Propício",
];

export const ALL_CITIES = [...PRIORITY_CITIES, ...OTHER_CITIES];
